...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('This Movie Not Found In DataBase Contact @ptstark (admin) to add This Movie file📂')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            msg1 = await query.message.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton('📢 Join Channel 📢', url ="https://t.me/+andrew_bot_files")
                        ],
                        [
        ...
        buttons = [[
        InlineKeyboardButton('Developers', url='https://t.me/DTG_BOTZ'),
